    ...
    def case_contract_editor_preserves_unresolved_reference_ids_in_dialog_payload(self):
        ...
        detail = ContractDetail(
            contract=ContractRecord(
                ...
                contract_number_mode=None,
                license_number_mode=None,
                registry_sha256_key_mode=None,
                contract_registry_entry_id=None,
                contract_external_code_identifier_id=None,
                license_registry_entry_id=None,
                license_external_code_identifier_id=None,
                registry_sha256_key_entry_id=None,
                registry_sha256_key_external_code_identifier_id=None,
                draft_date=None,
                signature_date=None,
                effective_date=None,
                start_date=None,
