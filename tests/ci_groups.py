...
GROUP_MODULES: dict[str, tuple[str, ...]] = {
    "catalog-services": (
        ...
        "tests.contract_templates.test_formatting",
        ...
        "tests.contract_templates.test_accounting_integration",
        ...
        "tests.invoicing.test_royalty_import",
        ...
        "tests.test_conversion_adapters_base",
        "tests.test_conversion_adapters_database",
        "tests.test_conversion_mapping_sounds_authority",
    ...
    "ui-app-workflows": (
        ...
        "tests.test_import_review_dialog",
        ...
        "tests.test_workspace_controller_wrappers",
