...
[![QA/PQ Dashboard](https://img.shields.io/badge/QA%2FPQ-dashboard-live-success)](https://cosmowyn.github.io/ISRC-Catalog-Manager/validation/)
...
Release package names include the app name, version tag, platform, architecture, and archive type,
for example `ISRCManager-v3.3.3-linux-x64.tar.gz`.
