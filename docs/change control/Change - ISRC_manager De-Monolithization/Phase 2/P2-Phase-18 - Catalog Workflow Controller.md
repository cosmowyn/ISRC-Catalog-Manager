# Codex Prompt — Execute Phase 18 Only
...
Execute **Plan 2 / Phase 18 — Catalog Workflow Controller** only.

## Scope
- move dataset refresh
...
## Not allowed
- no unrelated feature-family workflow extraction
- no final `App` move
...
## Handoff filename
`P2 Phase 18 handoff.md`

## Execution order
1. Read the engineering plan
2. Confirm Phase 18 scope
3. Inspect catalog workflow code only as needed
4. Execute Phase 18 only
