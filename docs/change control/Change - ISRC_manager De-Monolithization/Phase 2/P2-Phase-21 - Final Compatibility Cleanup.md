# Codex Prompt — Execute Phase 21 Only
...
Execute **Plan 2 / Phase 21 — Final Compatibility Cleanup** only.
...
## Handoff filename
`P2 Phase 21 handoff.md`

## Execution order
1. Read the engineering plan
2. Confirm Phase 21 scope
3. Inspect final compatibility/glue surface only as needed
4. Execute Phase 21 only
