# Codex Prompt — Execute Phase 0 Only
...
Execute **Plan 1 / Phase 0 — Packaging and Compatibility Gate** only.

## Scope
- audit package parity for live `isrc_manager` packages
...
## Handoff filename
`P1 Phase 0 handoff.md`

## Execution order
1. Read the engineering plan
2. Confirm Phase 0 scope
3. Inspect packaging/package layout only as needed
