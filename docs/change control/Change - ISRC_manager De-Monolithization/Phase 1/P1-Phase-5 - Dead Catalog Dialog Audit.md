...
- account for the current `open_catalog_managers_dialog()` redirect to diagnostics cleanup
...
- cleanup of compatibility aliases for these dialogs if no live/root-tested caller remains
