# Codex Prompt — Execute Phase 7 Only
...
Execute **Plan 1 / Phase 7 — Settings Dialog Whole Move** only.

## Scope
- move `ApplicationSettingsDialog` as-is first
- preserve compatibility alias
- avoid internal decomposition in this phase except what is required to move safely

## Allowed
- extraction into `isrc_manager/application_settings_dialog.py`
- compatibility imports/re-exports
- narrowly required import fixes and seams
- focused settings/theme/GS1/QSS autocomplete/app-sound validation

## Not allowed
- no internal settings dialog decomposition beyond what is needed for safe movement
...
- app sound settings remain visible and round-trip correctly
...
2. Confirm Phase 7 scope
3. Inspect settings dialog dependencies only as needed
4. Execute Phase 7 only
