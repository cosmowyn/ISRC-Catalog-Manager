...
Write a detailed handoff document after completing B3.
...
- confirmation that no non-B3 live behavior was cut over
...
- `B3 — completed — 18-apr-2026 14:32`
- `Exceptions: none`

or, if exceptions occurred:

- `B3 — completed with exceptions — 18-apr-2026 14:32`
- `Exceptions: B3.1, B3.2`
...
- `B3.1 — Phase B3 — shell flip required one temporary compatibility wrapper to keep existing call sites stable — resolved`
- `B3.2 — Phase B3 — one badge/icon parity issue identified during validation and deferred to B4 because it is outside B3 scope — open`
