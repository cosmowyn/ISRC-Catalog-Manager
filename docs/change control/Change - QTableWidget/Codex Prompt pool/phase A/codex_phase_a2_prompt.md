...
Write a detailed handoff document after completing A2.
...
- risks or follow-up notes for A3/A4
- any repo-specific conventions discovered that matter for later phases

The handoff must be detailed enough that the next engineer or Codex pass can continue from A3 or A4 without rediscovering context.
...
- `A2 — completed — 18-apr-2026 14:32`
- `Exceptions: none`

or, if exceptions occurred:

- `A2 — completed with exceptions — 18-apr-2026 14:32`
- `Exceptions: A2.1, A2.2`
...
- `A2.1 — Phase A2 — one model role constant needed a naming adjustment to match repo conventions — resolved`
- `A2.2 — Phase A2 — optional dormant import added for type-only compatibility seam — open`
