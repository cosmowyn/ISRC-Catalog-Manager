...
- [Bundled HTML License Template Example](../HTML%20license%20template/README.md): print-safe starter package, placeholder list, asset rules, draft-generation notes, and legal disclaimer
