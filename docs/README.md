...
- Read [Audio Authenticity Workflow](audio-authenticity-workflow.md) if you need signed master-watermark exports, provenance-sidecar derivatives, or want to verify audio files against the current catalog.
