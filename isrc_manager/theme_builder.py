...
from PySide6.QtCore import QEventLoop, QPointF, Qt
...
THEME_METRIC_FIELD_SPECS: tuple[ThemeMetricFieldSpec, ...] = (
    ...
    ThemeMetricFieldSpec(
        ...
        "Toolbar Top Margin",
        "Space between the top of the catalog table dock content and the catalog toolbar group titles.",
        0,
        16,
        3,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Group Gap",
        "Horizontal gap between the Search, Catalog Totals, and Zoom groups.",
        0,
        32,
        10,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "navigation",
        "Catalog Table Toolbar",
        "Side Group Extra Width",
        "Extra width added to the left Search and right Zoom groups while keeping Catalog Totals at its natural width.",
        0,
        300,
        100,
        " px",
    ...
    ThemeMetricFieldSpec(
        "catalog_toolbar_group_margin_top",
        "navigation",
        "Catalog Table Toolbar",
        "Group Title Margin",
        "Top margin reserved for the catalog toolbar group box titles.",
        0,
        24,
        8,
        " px",
    ...
    ThemeMetricFieldSpec(
        "catalog_toolbar_group_padding_top",
        "navigation",
        "Catalog Table Toolbar",
        "Group Top Padding",
        "Additional top padding inside catalog toolbar group boxes.",
        0,
        24,
        0,
        " px",
    ...
    ThemeMetricFieldSpec(
        "catalog_toolbar_group_title_left",
        "navigation",
        "Catalog Table Toolbar",
        "Title Left Offset",
        "Left inset used for Search, Catalog Totals, and Zoom group titles.",
        0,
        24,
        7,
        " px",
    ...
    ThemeMetricFieldSpec(
        "catalog_toolbar_group_title_padding_h",
        "navigation",
        "Catalog Table Toolbar",
        "Title Side Padding",
        "Horizontal padding around catalog toolbar group title text.",
        0,
        16,
        3,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Group Inner Margin",
        "Margin between catalog toolbar group borders and their controls.",
        0,
        16,
        5,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Group Height",
        "Fixed height used for the Search, Catalog Totals, and Zoom group containers.",
        36,
        80,
        50,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Control Gap",
        "Horizontal spacing between controls inside catalog toolbar groups.",
        0,
        24,
        6,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Control Height",
        "Maximum height used for catalog toolbar combo boxes, fields, sliders, labels, and reset buttons.",
        14,
        36,
        20,
        " px",
    ...
    ThemeMetricFieldSpec(
        "catalog_toolbar_control_padding_v",
        "navigation",
        "Catalog Table Toolbar",
        "Control Vertical Padding",
        "Vertical padding inside compact catalog toolbar combo boxes, fields, and reset buttons.",
        0,
        8,
        0,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Zoom Value Height",
        "Maximum height for the zoom percentage label above the catalog zoom slider.",
        5,
        24,
        16,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "navigation",
        "Catalog Table Toolbar",
        "Zoom Value Font Size",
        "Pixel font size used for the compact zoom percentage label.",
        5,
        18,
        14,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Zoom Row Gap",
        "Vertical spacing between the zoom percentage label and the zoom slider row.",
        0,
        12,
        0,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "Catalog Table Toolbar",
        "Zoom Slider Height",
        "Maximum height used for the catalog zoom slider row.",
        6,
        24,
        20,
        " px",
    ...
    ThemeMetricFieldSpec(
        ...
        "navigation",
        "Catalog Table Toolbar",
        "Zoom Step Button Size",
        "Width and height used for the catalog zoom minus and plus buttons.",
        14,
        32,
        20,
        " px",
    ...
    ThemeMetricFieldSpec(
        "catalog_toolbar_zoom_step_button_padding",
        "navigation",
        "Catalog Table Toolbar",
        "Zoom Step Button Padding",
        "Internal padding for the catalog zoom minus and plus buttons.",
        0,
        8,
        0,
        " px",
...
def theme_setting_defaults() -> dict[str, object]:
    ...
    return {
        ...
        "header_padding_v": 6,
        "header_padding_h": 8,
        "catalog_toolbar_top_margin": 3,
        "catalog_toolbar_column_gap": 10,
        "catalog_toolbar_side_group_extra_width": 100,
        "catalog_toolbar_group_margin_top": 8,
        "catalog_toolbar_group_padding_top": 0,
        "catalog_toolbar_group_title_left": 7,
        "catalog_toolbar_group_title_padding_h": 3,
        "catalog_toolbar_group_margin": 5,
        "catalog_toolbar_group_height": 50,
        "catalog_toolbar_control_gap": 6,
        "catalog_toolbar_control_height": 20,
        "catalog_toolbar_control_padding_v": 0,
        "catalog_toolbar_zoom_label_height": 21,
        "catalog_toolbar_zoom_label_font_size": 18,
        "catalog_toolbar_zoom_row_gap": 0,
        "catalog_toolbar_zoom_slider_height": 20,
        "catalog_toolbar_zoom_step_button_size": 20,
        "catalog_toolbar_zoom_step_button_padding": 0,
        "tab_radius": 8,
        "menu_radius": 8,
        "selected_name": "",
        "custom_qss": "",
...
def build_theme_stylesheet(raw_values: dict[str, object] | None = None) -> str:
    ...
    QWidget#catalogTablePanel QGroupBox#catalogTableZoomGroup {{
        margin-top: {int(theme["catalog_toolbar_group_margin_top"])}px;
        padding-top: {int(theme["catalog_toolbar_group_padding_top"])}px;
    }}
    QWidget#catalogTablePanel QGroupBox#catalogTableSearchGroup::title,
    QWidget#catalogTablePanel QGroupBox#catalogTableInfoGroup::title,
    QWidget#catalogTablePanel QGroupBox#catalogTableZoomGroup::title {{
        subcontrol-origin: margin;
        left: {int(theme["catalog_toolbar_group_title_left"])}px;
        padding: 0 {int(theme["catalog_toolbar_group_title_padding_h"])}px;
        color: {theme["group_title_fg"]};
    }}
    QWidget#catalogTablePanel QGroupBox QComboBox,
    QWidget#catalogTablePanel QGroupBox QLineEdit,
    QWidget#catalogTablePanel QGroupBox QPushButton {{
    ...
    QWidget#catalogTablePanel QPushButton#catalogTableZoomIncreaseButton {{
        ...
        max-width: {int(theme["catalog_toolbar_zoom_step_button_size"])}px;
        min-height: {int(theme["catalog_toolbar_zoom_step_button_size"])}px;
        min-width: {int(theme["catalog_toolbar_zoom_step_button_size"])}px;
        padding: {int(theme["catalog_toolbar_zoom_step_button_padding"])}px;
    }}
    QWidget#catalogTablePanel QLabel#catalogTableZoomValueLabel {{
        font-size: {int(theme["catalog_toolbar_zoom_label_font_size"])}px;
    }}
...
def _theme_setting_defaults() -> dict[str, object]:
    return theme_setting_defaults()


def _theme_setting_keys() -> tuple[str, ...]:
    return theme_setting_keys()


def _normalize_theme_string(value) -> str:
    return normalize_theme_string(value)
...
def _normalize_theme_font_family(value, fallback) -> str:
    return normalize_theme_font_family(value, fallback)
...
def _normalize_theme_settings(app, values: dict[str, object] | None) -> dict[str, object]:
    return normalize_theme_settings(values)
...
def _color_relative_luminance(color_value: str) -> float:
    return color_relative_luminance(color_value)


def _contrast_ratio(fg_value: str, bg_value: str) -> float:
    return contrast_ratio(fg_value, bg_value)


def _pick_contrasting_color(bg_value: str) -> str:
    return pick_contrasting_color(bg_value)


def _shift_color(color_value: str, factor: int) -> str:
    return shift_color(color_value, factor)


def _effective_theme_settings(
    app, raw_values: dict[str, object] | None = None
) -> dict[str, object]:
    return effective_theme_settings(raw_values or app.theme_settings)
...
def _build_theme_stylesheet(app, raw_values: dict[str, object] | None = None) -> str:
    return build_theme_stylesheet(raw_values or app.theme_settings)
...
def _apply_theme(app, raw_values: dict[str, object] | None = None) -> None:
    ...
    qt_app.setFont(font)
    palette = build_theme_palette(normalized)
    qt_app.setPalette(palette)
    app.setPalette(palette)
    qt_app.setStyle(build_theme_style(normalized))
...
def _prepare_theme_application_payload(
    ...
    return {
        ...
        "stylesheet": build_theme_stylesheet(normalized),
    }
...
def _apply_theme_with_loading(
    ...
    *,
    ...
    if task_id is None:
        ...
        message = getattr(task_failure, "message", "Task could not start.")
        raise RuntimeError(message)
    if not prepared and "value" not in failure and not cancelled["value"]:
        loop.exec()
    if "value" in failure:
        raise RuntimeError(str(getattr(failure["value"], "message", "")))
    if cancelled["value"]:
        return
