    ...
    def __init__(
        ...
        *,
        ...
        _add_standard_dialog_header(
            ...
            title="Work Manager",
            subtitle=(
                "Use Work Manager as the governance and management layer. Review work metadata, "
                "linked tracks, and parent-child relationships here after or alongside track-first entry."
            ),
        )
