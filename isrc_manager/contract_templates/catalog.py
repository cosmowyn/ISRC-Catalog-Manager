...
_NAMESPACE_ORDER = ("track", "release", "work", "contract", "party", "right", "asset", "custom")
...
_STATIC_SEEDS: tuple[_CatalogSeed, ...] = _track_seeds() + (
    ...
    _CatalogSeed("release", "version_subtitle", "Version Subtitle", "text", "Releases", "version_subtitle"),
    _CatalogSeed("release", "primary_artist", "Primary Artist", "text", "Releases", "primary_artist"),
    ...
    _CatalogSeed("release", "catalog_number", "Catalog Number", "text", "Releases", "catalog_number"),
    ...
    _CatalogSeed("release", "explicit_flag", "Explicit Release", "checkbox", "Releases", "explicit_flag"),
    _CatalogSeed("release", "repertoire_status", "Repertoire Status", "text", "Releases", "repertoire_status"),
    _CatalogSeed("release", "metadata_complete", "Metadata Complete", "checkbox", "Releases", "metadata_complete"),
    _CatalogSeed("release", "contract_signed", "Contract Signed", "checkbox", "Releases", "contract_signed"),
    _CatalogSeed("release", "rights_verified", "Rights Verified", "checkbox", "Releases", "rights_verified"),
    _CatalogSeed("release", "notes", "Release Notes", "text", "Releases", "release_notes"),
    _CatalogSeed("work", "title", "Work Title", "text", "Works", "title"),
    _CatalogSeed("work", "version_subtitle", "Version Subtitle", "text", "Works", "version_subtitle"),
    ...
    _CatalogSeed("work", "registration_number", "Registration Number", "text", "Works", "registration_number"),
    _CatalogSeed(
        "work",
        "work_status",
        "Work Status",
    ...
    _CatalogSeed("work", "instrumental_flag", "Instrumental", "checkbox", "Works", "instrumental_flag"),
    _CatalogSeed("work", "metadata_complete", "Metadata Complete", "checkbox", "Works", "metadata_complete"),
    _CatalogSeed("work", "contract_signed", "Contract Signed", "checkbox", "Works", "contract_signed"),
    _CatalogSeed("work", "rights_verified", "Rights Verified", "checkbox", "Works", "rights_verified"),
    _CatalogSeed("work", "notes", "Work Notes", "text", "Works", "notes"),
    _CatalogSeed("contract", "title", "Contract Title", "text", "Contracts", "title"),
    _CatalogSeed("contract", "contract_type", "Contract Type", "text", "Contracts", "contract_type"),
    _CatalogSeed("contract", "draft_date", "Draft Date", "date", "Contracts", "draft_date"),
    _CatalogSeed("contract", "signature_date", "Signature Date", "date", "Contracts", "signature_date"),
    _CatalogSeed("contract", "effective_date", "Effective Date", "date", "Contracts", "effective_date"),
    ...
    _CatalogSeed("contract", "notice_deadline", "Notice Deadline", "date", "Contracts", "notice_deadline"),
    _CatalogSeed("contract", "option_periods", "Option Periods", "text", "Contracts", "option_periods"),
    _CatalogSeed("contract", "reversion_date", "Reversion Date", "date", "Contracts", "reversion_date"),
    _CatalogSeed("contract", "termination_date", "Termination Date", "date", "Contracts", "termination_date"),
    _CatalogSeed(
        "contract",
        "status",
        "Contract Status",
    ...
    _CatalogSeed("party", "pro_affiliation", "PRO Affiliation", "text", "Parties", "pro_affiliation"),
    ...
    _CatalogSeed("right", "source_contract_title", "Source Contract Title", "text", "Contracts", "title"),
    ...
    _CatalogSeed("asset", "approved_for_use", "Approved For Use", "checkbox", "AssetVersions", "approved_for_use"),
    _CatalogSeed("asset", "primary_flag", "Primary Asset", "checkbox", "AssetVersions", "primary_flag"),
    _CatalogSeed("asset", "version_status", "Version Status", "text", "AssetVersions", "version_status"),
    ...
    def list_known_symbols(
        ...
        *,
        ...
        return sorted(
            entries,
            key=lambda item: (
                _NAMESPACE_ORDER.index(item.namespace) if item.namespace in _NAMESPACE_ORDER else 999,
        ...
        for field in fields:
            ...
            entries.append(
                ContractTemplateCatalogEntry(
                    ...
                    description=(
                        f"Track custom field '{str(field.get('name') or field_id)}'."
                    ),
