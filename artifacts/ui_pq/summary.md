...
- Generated: 2026-08-08T10:05:34.423460+00:00
- Inventory items discovered: 413
- Traceability rows written: 413
- Automated traceability rows: 392
- Pending/manual/out-of-scope rows: 21
- Deviations recorded: 22
- Open actionable deviations: 1
- Pending/manual deviations: 21
- Object-name gap deviations: 0
- QA database: /private/var/folders/6n/jmt1mclx4db3_18pj0z9n8l40000gn/T/tmpbjolizkd/qt-settings/AppLocalDataLocation/Database/default.db
...
- `UI-PQ-SET-001` passed: Visual screenshots, baseline comparison, dialog capture, credential-reset reachability without activation, and theme payload verification completed.
...
- `UI-PQ-HIST-001` passed: Profile Undo and Redo used the exclusive background replay contract, reported phase-based progress, and restored the expected catalog states.
...
- `UI-PQ-ACC-001` passed: Invoice creation, invoice posting, payment entry, credit note creation, royalty statement generation, payout creation, report generation, and balanced ledger checks were executed through UI controls.
...
- `UI-PQ-IMP-001` failed: generated output workflow failed: AssertionError: report comparison failed for 'ui_pq_report_summary': artifacts/ui_pq/visual/actual/ui_pq_report_summary.json != artifacts/ui_pq/visual/baselines/ui_pq_report_summary.json
- `UI-PQ-ASSET-001` passed: Deliverables and Asset Versions action, dock, asset table, search, and derivative ledger navigation plus reversible managed Asset deletion were qualified.
